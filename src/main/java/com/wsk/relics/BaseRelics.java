...
public class BaseRelics extends CustomRelic {
    ...
    public BaseRelics() {
        super(ID, new Texture(CommonUtil.getResourcePath(IMG_PATH)), new Texture(CommonUtil.getResourcePath(OUTLINE_IMG_PATH)),
