 ...
 * @desc 一句话说明
 */
public class DeathBolgPowerBase extends BaseSpearPower {
    public static final String POWER_ID = "MyMod:DeathBolgPowerBase";//能力的ID，判断有无能力、能力层数时填写该Id而不是类名。
    ...
    public DeathBolgPowerBase(AbstractCreature owner, int amount) {
