 ...
 * @desc 一句话说明
 */
public class RemoveArmorPower extends AbstractPower {
    public static final String POWER_ID = "LagranYue:RemoveArmorPower";//能力的ID，判断有无能力、能力层数时填写该Id而不是类名。
    ...
    public RemoveArmorPower(AbstractCreature owner, int amount) {//参数：owner-能力施加对象、amount-施加能力层数。在cards的use里面用ApplyPowerAction调用进行传递。
        this.ID = POWER_ID;
