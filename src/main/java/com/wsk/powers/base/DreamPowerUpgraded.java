...
public class DreamPowerUpgraded extends AbstractPower {
    public static final String POWER_ID = "LagranYue:DreamPowerUpgraded";//能力的ID，判断有无能力、能力层数时填写该Id而不是类名。
    public static final String NAME = "远离尘世的理想+";//能力的名称。

    public static final String[] DESCRIPTIONS = {"每回合开始，选择获得", "张被消耗的卡牌，并且费用置为0。"};//需要调用变量的文本描叙，例如力量（Strength）、敏捷（Dexterity）等。
