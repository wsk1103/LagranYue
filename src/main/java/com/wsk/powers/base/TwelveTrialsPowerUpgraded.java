...
public class TwelveTrialsPowerUpgraded extends AbstractPower {
    public static final String POWER_ID = "LagranYue:TwelveTrialsPowerUpgraded";
    ...
    public TwelveTrialsPowerUpgraded(AbstractCreature owner, int amount) {//参数：owner-能力施加对象、amount-施加能力层数。在cards的use里面用ApplyPowerAction调用进行传递。
        this.ID = POWER_ID;
