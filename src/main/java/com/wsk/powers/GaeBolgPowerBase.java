 ...
 * @desc 兵器：刺穿死棘之枪
 */
public class GaeBolgPowerBase extends BaseSpearPower {
    public static final String POWER_ID = "MyMod:GaeBolgPowerBase";//能力的ID，判断有无能力、能力层数时填写该Id而不是类名。
    ...
    public GaeBolgPowerBase(AbstractCreature owner, int amount, int platedArmor) {
