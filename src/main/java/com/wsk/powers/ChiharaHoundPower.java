...
public class ChiharaHoundPower extends AbstractArchPower {
    ...
    public ChiharaHoundPower(AbstractCreature owner, AbstractMonster abstractMonster, int amount, boolean update) {//参数：owner-能力施加对象、amount-施加能力层数。在cards的use里面用ApplyPowerAction调用进行传递。
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
