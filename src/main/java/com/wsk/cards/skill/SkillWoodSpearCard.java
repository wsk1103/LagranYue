...
public class SkillWoodSpearCard extends AbstractSpearCard {
    public static final String ID = "MyMod:SkillWoodSpearCard";//卡牌在游戏中的id
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        //获得能力
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new BaseSpearPower(p, this.magicNumber), this.magicNumber));
    }
