...
public class SkillBrokenShieldCard extends AbstractShieldCard {
    public static final String ID = "MyMod:SkillBrokenShieldCard";//卡牌在游戏中的id
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        //获得能力
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new BaseShieldPower(p, this.magicNumber), this.magicNumber));
    }
