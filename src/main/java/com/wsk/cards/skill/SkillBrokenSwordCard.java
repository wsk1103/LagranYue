...
public class SkillBrokenSwordCard extends AbstractSwordCard {
    public static final String ID = "MyMod:SkillBrokenSwordCard";//卡牌在游戏中的id
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        //获得能力
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new BaseSwordPower(p, this.magicNumber), this.magicNumber));
    }
