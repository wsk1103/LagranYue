...
public class SkillIncompleteArchCard extends AbstractArchCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        //获得能力
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new BaseArchPower(p, this.magicNumber), this.magicNumber, AbstractGameAction.AttackEffect.POISON));
    }
