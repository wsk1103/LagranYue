 ...
 * @description 宝玉的解放
 */
public class SkillLiberationCard extends AbstractProfShieldCard {

    /**
     * 卡牌在游戏中的id
     */
    public static final String ID = "LagranYue:SkillLiberationCard";
    /**
     * 卡牌显示的名称
     */
     ...
     * 卡牌牌面的图片路径。
     */
    private static final String IMG = "cards/SkillLiberationCard.png";
    ...
    public AbstractCard makeCopy() {
        return new SkillLiberationCard();
    }
