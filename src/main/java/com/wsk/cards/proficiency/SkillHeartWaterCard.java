 ...
 * @description 明镜止水之心
 */
public class SkillHeartWaterCard extends AbstractProfShieldCard {

    /**
     * 卡牌在游戏中的id
     */
    public static final String ID = "LagranYue:SkillHeartWaterCard";
    /**
     * 卡牌显示的名称
     */
     ...
     * 卡牌牌面的图片路径。
     */
    private static final String IMG = "cards/SkillHeartWaterCard.png";
    ...
    public AbstractCard makeCopy() {
        return new SkillHeartWaterCard();
    }
