 ...
 * @description 魔月之剑刃
 */
public class AttackMagicMoonCard extends AbstractProfSwordCard {

    /**
     * 卡牌在游戏中的id
     */
    public static final String ID = "LagranYue:AttackMagicMoonCard";
    /**
     * 卡牌显示的名称
     */
    ...
    public AbstractCard makeCopy() {
        return new AttackMagicMoonCard();
    }
