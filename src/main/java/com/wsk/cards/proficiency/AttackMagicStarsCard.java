 ...
 * @author wsk1103
 * @date 2019/3/20
 * @description 戏法明星魔法花冠
 */
public class AttackMagicStarsCard extends AbstractProfArchCard {

    /**
     * 卡牌在游戏中的id
     */
    public static final String ID = "LagranYue:AttackMagicStarsCard";
    /**
     * 卡牌显示的名称
     */
     ...
     * 卡牌牌面的图片路径。
     */
    private static final String IMG = "cards/AttackMagicStarsCard.png";
    ...
    public AbstractCard makeCopy() {
        return new AttackMagicStarsCard();
    }
