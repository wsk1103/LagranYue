 ...
 * @description 堕落
 */
public class AttackDegenerateCard extends AbstractProfSpearCard {

    /**
     * 卡牌在游戏中的id
     */
    public static final String ID = "LagranYue:AttackDegenerateCard";
    /**
     * 卡牌显示的名称
     */
    ...
    public AbstractCard makeCopy() {
        return new AttackDegenerateCard();
    }
