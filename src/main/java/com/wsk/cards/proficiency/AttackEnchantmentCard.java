...
import com.wsk.powers.proficiency.GoldRatePower;
 ...
 * @description 魅惑
 */
public class AttackEnchantmentCard extends AbstractProfSpearCard {

    /**
     * 卡牌在游戏中的id
     */
    public static final String ID = "LagranYue:AttackEnchantmentCard";
    /**
     * 卡牌显示的名称
     */
     ...
     * 卡牌牌面的图片路径。
     */
    private static final String IMG = "cards/AttackEnchantmentCard.png";
    ...
    public AbstractCard makeCopy() {
        return new AttackEnchantmentCard();
    }
...
//            this.isInnate = false;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        ActionUtil.addPower(p, new GoldRatePower(p, 1));
    }
