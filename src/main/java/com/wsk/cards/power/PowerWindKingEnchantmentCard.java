 ...
 * @desc 一句话说明
 */
public class PowerWindKingEnchantmentCard extends CustomCard {
    public static final String ID = "LagranYue:PowerWindKingEnchantmentCard";//卡牌在游戏中的id
    ...
    private static final String IMG = "cards/PowerWindKingEnchantmentCard.png";//卡牌牌面的图片路径。
    //例：img/cards/claw/attack/BloodSuckingClaw_Orange.png  详细情况请根据自己项目的路径布置进行填写。

    private static final int COST = 3;//卡牌的费用。

    public PowerWindKingEnchantmentCard() {
    ...
    public AbstractCard makeCopy() {
        return new PowerWindKingEnchantmentCard();
    }
