...
import com.wsk.powers.TwelveTrialsPower;
import com.wsk.powers.TwelveTrialsPowerUpgraded;
...
public class PowerTwelveTrialsCard extends CustomCard {
    public static final String ID = "LagranYue:PowerTwelveTrialsCard";//卡牌在游戏中的id
    ...
    private static final String IMG = "cards/PowerTwelveTrialsCard.png";//卡牌牌面的图片路径。
