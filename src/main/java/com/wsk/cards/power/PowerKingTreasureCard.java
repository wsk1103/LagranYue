...
import com.wsk.powers.KingTreasurePower;
import com.wsk.powers.KingTreasurePowerUpgraded;
...
public class PowerKingTreasureCard extends CustomCard {
    public static final String ID = "LagranYue:PowerKingTreasureCard";//卡牌在游戏中的id
