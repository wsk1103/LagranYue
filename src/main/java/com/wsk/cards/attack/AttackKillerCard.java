...
public class AttackKillerCard extends CustomCard {
    public static final String ID = "LagranYue:AttackKillerCard";//卡牌在游戏中的id
    ...
    private static final String IMG = "cards/AttackKillerCard.png";//卡牌牌面的图片路径。
        ...
        if (upgraded) {
            if (num == 0) {
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
                        new VictoryPower(p, this.magicNumber), this.magicNumber, true, AbstractGameAction.AttackEffect.NONE));
            } else {
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
