 ...
 * @desc 一句话说明
 */
public class AttackDevilCard extends CustomCard {
    public static final String ID = "LagranYue:AttackDevilCard";//卡牌在游戏中的id
    ...
    private static final String IMG = "cards/AttackDevilCard.png";//卡牌牌面的图片路径。
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {//局部变量：p-玩家，m敌人。
        ...
        if (!upgraded) {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
                    new ImprintPower(p, p, this.magicNumber), this.magicNumber, true, AbstractGameAction.AttackEffect.POISON));
        }
    }//注：卡牌效果的diy区。
